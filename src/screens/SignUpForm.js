...
export const SignUpForm = ({route}) => {
  ...
  async function handle(){
    ...
    let a = [Nom,Prenom,phone,email,Password,confirmpassword];
...
return (
    <SafeAreaView style={styles.container}>
        ...
        <InputStyle label='Nom' setText={setNom}/>
        <InputStyle label='Prenom' setText={setPrenom} />
